...
public class VentanaDevolverEstudiante extends Frame{
	...
	public VentanaDevolverEstudiante(){
		...
		add(tfAnio);
		add(new Label("Matricula del estudiante que hace la devolucion"));
	...
	class alGuardar implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			controladorEstudiante.devolverPrestamoEstudiante(d,m,a,titu,np);
		}
	}
}
